    ...
    <section className="py-8 mb-10 lg:py-12 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            {/* Main Image */}
            <div className="absolute top-0 left-0 w-4/5 h-4/5 border-r-3 border-[#06ac5e] overflow-hidden shadow-2xl">
              <Image
                src="/images/whychooseus-1.jpg"
                alt="Why choose us - main image"
                fill
            ...
            {/* Secondary Image */}
            <div
              className="absolute bottom-0 right-0 w-3/5 h-3/5 rounded-xl overflow-hidden shadow-2xl border-3 border-[#06ac5e]"
              data-aos="fade-up"
              data-aos-delay="300"
              data-aos-duration="1000"
            >
            ...
            {/* Floating Badge */}
            <div
              className="absolute top-1/4 -translate-y-1/2 -right-4 lg:-right-12 bg-white p-5 lg:p-6 border-l-3 border-[#06ac5e]   flex items-center gap-4 z-10"
              data-aos="zoom-in"
              data-aos-delay="600"
            >
