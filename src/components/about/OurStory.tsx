      ...
      <div className="px-6 sm:px-12 lg:px-20">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="">
            ...
            <div
              className="space-y-6 tracking-wider"
              data-aos="fade-up"
              data-aos-delay="200"
              data-aos-duration="800"
            >
            ...
            >
              {[
                ...
                <div key={index} className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gray-100 text-[#06ac5e] flex items-center justify-center text-xs font-bold">
                    {milestone.year.slice(-2)}
                  </div>
                  <div>
                    <p className="text-xs text-black font-thin uppercase tracking-wider">
                      {milestone.year}
                    </p>
          ...
          <div className="relative h-[500px] lg:h-[650px]">
            ...
            {/* Secondary Image */}
            <div
              className="absolute bottom-0 left-0 w-3/5 h-2/5 rounded-xl overflow-hidden shadow-xl border-3 border-white z-10"
              data-aos="fade-up"
              data-aos-delay="300"
              data-aos-duration="1000"
            >
