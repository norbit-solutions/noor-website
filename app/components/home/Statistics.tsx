          ...
          {STATS.map((stat, index) => (
            ...
            >
              ...
              <div className="mb-4 overflow-hidden">
                <span
                  className="block text-5xl font-bold text-black transition-transform duration-500 group-hover:-translate-y-2 sm:text-6xl lg:text-7xl"
                  data-aos="zoom-in"
              ...
              {/* Label */}
              <h3 className="mb-2 text-sm font-semibold uppercase tracking-wider text-black">
