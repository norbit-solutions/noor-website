...
export default function SecondaryHero({
  ...
  return (
    ...
    >
        ...
        >
          {stats.map((stat, index) => (
            <div key={index}>
              ...
              <span className="block text-sm text-white/50 font-medium uppercase tracking-wider">
                {stat.label}
              </span>
            </div>
          ))}
      ...
      <div className="absolute left-6 top-1/2 hidden h-32 w-px -translate-y-1/2 bg-gradient-to-b from-transparent via-white/20 to-transparent lg:block" />
